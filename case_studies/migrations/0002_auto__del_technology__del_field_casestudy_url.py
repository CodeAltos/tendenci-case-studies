...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CaseStudy.url'
        db.delete_column('case_studies_casestudy', 'url')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'CaseStudy.url'
        db.add_column('case_studies_casestudy', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 15, 12, 1, 728021)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 15, 12, 1, 727844)'}),
        ...
        'case_studies.casestudy': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['case_studies.Service']", 'null': 'True', 'blank': 'True'}),
